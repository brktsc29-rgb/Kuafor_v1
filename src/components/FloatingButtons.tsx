  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-center gap-3">
      ...
      <a
        ...
        className="pulse-whatsapp w-14 h-14 rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110"
        style={{
          background: '#25D366',
      ...
      <a
        ...
        className="w-14 h-14 rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110"
        style={{
          background: 'linear-gradient(135deg, #B9816F, #C9917F)',
          boxShadow: '0 4px 20px rgba(185,129,111,0.40)',
        }}
      >
        <svg
          width="22"
