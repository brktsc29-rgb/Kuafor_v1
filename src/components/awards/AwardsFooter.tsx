...
export default function AwardsFooter({ onOpenKVKK }: { onOpenKVKK: () => void }) {
  return (
    ...
    <div
      className="flex flex-col sm:flex-row items-center justify-center gap-3 px-6 py-3"
      style={{ background: '#1A1210', borderTop: '1px solid rgba(248,245,242,0.04)' }}
    >
      <p style={{ fontFamily: 'Inter, sans-serif', color: 'rgba(248,245,242,0.30)', fontSize: '0.65rem', letterSpacing: '0.06em' }}>
        Bu gibi bir web sitesi yaptırmak ister misiniz?
      </p>
      <a
        href="https://wa.me/905380590173?text=Merhaba%2C%20web%20sitesi%20yapt%C4%B1rmak%20istiyorum."
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 rounded-full px-4 py-1.5 transition-opacity hover:opacity-90"
        style={{ background: 'rgba(201,143,122,0.15)', border: '1px solid rgba(201,143,122,0.25)' }}
      >
        ...
        <span style={{ fontFamily: 'Inter, sans-serif', color: '#C98F7A', fontSize: '0.65rem', letterSpacing: '0.06em' }}>
          0538 059 01 73
        </span>
      </a>
    </div>
