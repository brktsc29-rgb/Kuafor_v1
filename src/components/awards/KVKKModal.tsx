...
export default function KVKKModal({ isOpen, onClose }: Props) {
  useEffect(() => {
    if (isOpen) {
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                onClick={onClose}
                style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(42,33,29,0.4)', fontSize: '1.4rem', lineHeight: 1, padding: '4px 8px' }}
              >
                ✕
              </button>
            </div>
